...
In den Abbildungen \ref{fig:bl}--\ref{fig:ba} sind die Signalformen der unbekannten Bauelemente aufgetragen. Der jeweiligen Bildunterschrift ist das daraus abgeleitete Bauteil zu entnehmen, worauf aufgrund des charakteristischen Verlaufs (in der Anleitung angegeben) des jeweiligen Bauteils geschlossen werden kann. Ganz analog zu Abschnitt~\ref{sec:everybodyhatessmithcharts} kann daraufhin mit einem exponentiellen Fit (Parameter in \autoref{tab:bauteile}) der jeweils interessante Bauteilparameter bestimmt werden. Es folgt für die Induktivität
\begin{align}
  L_1 &= \SI{90.8}{\micro\henry}
  \intertext{für den Abschlusswiderstand eine Restinduktivität von}
  L_2 &= \SI{9.78}{\micro\henry}
  \intertext{und für den Kondensator}
  C &= \SI{117.9}{\nano\farad}.
\end{align}
Der Reflexionsfaktor des Kondensators beträgt
\begin{align}
  \Gamma = \frac{U_\mathrm{Sättigung} - U_0}{U_0} = \frac{\SI{55.58}{\volt}}{\SI{55.2}{\volt}} = \num{1.007}.
\end{align}
