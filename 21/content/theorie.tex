...
\fig{bilder/aufspaltung.pdf}{Energieniveauaufspaltung eines Atoms durch ein angelegtes externes Magnetfeld \cite{anleitung21}.}{aufspaltung}[width=0.6\textwidth]
...
\end{equation}
beginnt sich das \ce{^2S_{1/2}}-Niveau mit $M_J=\frac{1}{2}$ durch induzierte Emission zu entleeren. Dadurch kann ein Teil des eingestrahlten Lichtes absorbiert werden, was zu einer abnehmenden Transparenz der Zelle führt. Der Verlauf ist in \autoref{fig:transparenz} dargestellt.
