...
\begin{figure}
  ...
  \includegraphics[width=0.9\textwidth] {build/plot1.pdf}
	\caption{Energieverlust der $\alpha$-Teilchen in Luft in Abhängigkeit vom Druck $p$.}
	\label{fig:luft}
\end{figure}
